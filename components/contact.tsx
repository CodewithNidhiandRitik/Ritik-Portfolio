...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (form.current) {
        const result = await emailjs.sendForm("service_05dg8gb", "template_nc3hzma" , form.current, "hVCchBBYiwnvcbVbL")
                ...
                <Card className="bg-black/30 dark:bg-white/70 border-none shadow-md">
                  <CardContent className="flex items-center gap-4 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#D1D5DB] dark:text-[#475569] text-sm">ritikgoswami34@gmail.com</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-black/30 dark:bg-white/70 border-none shadow-md">
                  <CardContent className="flex items-center gap-4 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#D1D5DB] dark:text-[#475569] text-sm">+91 8923273820</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-black/30 dark:bg-white/70 border-none shadow-md">
                  <CardContent className="flex items-center gap-4 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#D1D5DB] dark:text-[#475569] text-sm">Mathura, Uttar Pradeshr</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
